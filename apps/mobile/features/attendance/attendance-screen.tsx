...
export function AttendanceScreen({ sessionId, classroomId }: { sessionId: string; classroomId: string }) {
  ...
  const [search, setSearch] = useState(""); const [discardOpen, setDiscardOpen] = useState(false); const [exitOpen, setExitOpen] = useState(false); const [pickerStudentId, setPickerStudentId] = useState<string | null>(null);
