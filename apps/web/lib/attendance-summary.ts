...
export function summarizeAttendance(roster: Pick<SessionAttendanceResult, "students" | "enrolledCount">): AttendanceSummary {
  return summarizeSharedAttendance(roster);
}

export function attendanceActionLabel(summary: Pick<AttendanceSummary, "enrolled" | "recorded">, status: SessionStatus): string {
